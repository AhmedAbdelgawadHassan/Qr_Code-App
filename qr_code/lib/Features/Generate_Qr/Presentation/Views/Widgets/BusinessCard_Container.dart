    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Spacer(flex: 2,),
            Customtextformfield(label: "Company Name", hintText: "Enter Name", maxLines: 1,ScreenRatio: 0.65,),
          Spacer(),
         Customtextformfield(label: "Industry", hintText: "e.g Food/Agency", maxLines: 1,ScreenRatio: 0.65,),
          Spacer(),
           Row(
